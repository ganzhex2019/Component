...
public interface RouterInterceptor {
     ...
     * 此对象目前唯一的一个实现类为 {@link com.cambodia.zhanbang.component.impl.Navigator.InterceptorCallback}
     * 它内部持有 {@link com.cambodia.zhanbang.component.impl.Callback} 对象,
     * 间接的保证了 {@link com.cambodia.zhanbang.component.impl.Callback} 对象中的方法只被执行一次
     */
    interface Callback {
