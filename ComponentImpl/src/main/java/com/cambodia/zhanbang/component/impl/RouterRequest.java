...
import com.cambodia.zhanbang.component.support.ParameterSupport;
...
public class RouterRequest {
    ...
    public static class Builder extends URIBuilder {
         ...
         * <p>
         * 其实目标界面可以完全的自定义路由,这个功能实际上没有存在的必要,因为你可以为同一个界面添加上多个 {@link com.cambodia.zhanbang.component.anno.RouterAnno}
         * 然后每一个 {@link com.cambodia.zhanbang.component.anno.RouterAnno} 都可以有不同的行为.是可以完全的代替 {@link RouterRequest#intentConsumer} 方法的
         *
