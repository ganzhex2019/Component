...
import com.cambodia.zhanbang.component.bean.RouterAnnoBean;
import com.cambodia.zhanbang.component.bean.RouterDocBean;
...
public class RouterProcessor extends BaseHostProcessor {
    ...
    private final Map<String, com.cambodia.zhanbang.component.bean.RouterAnnoBean> routerMap = new HashMap<>();
    ...
    private void parseAnno(Set<? extends Element> routeElements) {
        for (Element element : routeElements) {
            ...
            final com.cambodia.zhanbang.component.bean.RouterAnnoBean routerBean = toRouterAnnoBean(element, router);
            // 如果重复就抛出异常
    ...
    private com.cambodia.zhanbang.component.bean.RouterAnnoBean toRouterAnnoBean(Element element, RouterAnno routerAnno) {
        ...
        final com.cambodia.zhanbang.component.bean.RouterAnnoBean routerBean = new com.cambodia.zhanbang.component.bean.RouterAnnoBean();
    ...
    private void adjustInterceptorPriorities() {
        routerMap.forEach(new BiConsumer<String, com.cambodia.zhanbang.component.bean.RouterAnnoBean>() {
            @Override
            public void accept(String s, com.cambodia.zhanbang.component.bean.RouterAnnoBean value) {
    ...
    private void createRouterJson() throws IOException {
        ...
        for (Map.Entry<String, com.cambodia.zhanbang.component.bean.RouterAnnoBean> entry : routerMap.entrySet()) {
            com.cambodia.zhanbang.component.bean.RouterAnnoBean routerAnnoBean = entry.getValue();
    ...
    private MethodSpec generateInitMapMethod() {
        ...
        routerMap.forEach(new BiConsumer<String, com.cambodia.zhanbang.component.bean.RouterAnnoBean>() {
            @Override
            public void accept(String key, com.cambodia.zhanbang.component.bean.RouterAnnoBean routerBean) {
     ...
     * 生成目标是 Activity 的调用
     */
    private void generateActivityCall(com.cambodia.zhanbang.component.bean.RouterAnnoBean routerBean, String routerBeanName, MethodSpec.Builder methodSpecBuilder) {
        ...
        methodSpecBuilder.addComment(BaseProcessor.NORMALLINE + commentStr + BaseProcessor.NORMALLINE);
        methodSpecBuilder.addCode("\n");
