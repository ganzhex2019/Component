...
import com.cambodia.zhanbang.component.anno.FragmentAnno;
        ...
        for (Element element : annoElements) {
            ...
            for (String interceptorName : interceptorNames) {
                if ("".equalsIgnoreCase(interceptorName)) {
                    throw new com.cambodia.zhanbang.component.ProcessException("the name of interceptor can't be empty or null");
                }
                // 模块不能有相同的
