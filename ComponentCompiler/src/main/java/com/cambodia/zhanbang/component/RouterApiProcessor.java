...
import com.cambodia.zhanbang.component.anno.ParameterAnno;
import com.cambodia.zhanbang.component.anno.router.AfterActionAnno;
import com.cambodia.zhanbang.component.anno.router.AfterErrorActionAnno;
import com.cambodia.zhanbang.component.anno.router.AfterEventActionAnno;
import com.cambodia.zhanbang.component.anno.router.AfterStartActionAnno;
import com.cambodia.zhanbang.component.anno.router.BeforActionAnno;
import com.cambodia.zhanbang.component.anno.router.BeforStartActionAnno;
import com.cambodia.zhanbang.component.anno.router.CategoryAnno;
import com.cambodia.zhanbang.component.anno.router.FlagAnno;
import com.cambodia.zhanbang.component.anno.router.HostAndPathAnno;
import com.cambodia.zhanbang.component.anno.router.HostAnno;
import com.cambodia.zhanbang.component.anno.router.NavigateAnno;
import com.cambodia.zhanbang.component.anno.router.OptionsAnno;
import com.cambodia.zhanbang.component.anno.router.PathAnno;
import com.cambodia.zhanbang.component.anno.router.RequestCodeAnno;
import com.cambodia.zhanbang.component.anno.router.RouterApiAnno;
import com.cambodia.zhanbang.component.anno.router.UseInteceptorAnno;
import com.cambodia.zhanbang.component.anno.router.UserInfoAnno;
...
public class RouterApiProcessor extends BaseProcessor {
    ...
    private void createRouterApiImpl(TypeElement typeElement) {
        ...
        try {
            ...
            throw new com.cambodia.zhanbang.component.ProcessException(e);
        }
    }
    ...
    private void implementInterfaceMethod(TypeSpec.Builder typeSpecBuilder, ExecutableElement executableElement, String defaultHost) {
        ...
        for (VariableElement parameter : parameters) {
            ...
            if (mTypes.isSubtype(parameterTypeMirror, contextTypeMirror)) { // 如果是一个 Context
                ...
                ParameterAnno parameterParameterAnno = parameter.getAnnotation(ParameterAnno.class);
                if (parameterParameterAnno == null) {
                    throw new com.cambodia.zhanbang.component.ProcessException("do you forget to add @ParameterAnno to you parameter(" + methodPath + "#" + parameter.getSimpleName().toString() + ")?");
                }
                    ...
                    if (mTypeElementArrayList.asType().equals(declaredType.asElement().asType())) { // 如果外层是 ArrayList
                        ...
                        if (typeArguments.size() == 1) {
                            if (mTypeElementString.asType().equals(typeArguments.get(0))) { // 如果是 String
                                ...
                                throw new com.cambodia.zhanbang.component.ProcessException("can't to resolve unknow type parameter(" + methodPath + "#" + parameter.getSimpleName().toString() + ")");
                            }
                        } else {
                            throw new com.cambodia.zhanbang.component.ProcessException("can't to resolve unknow type parameter(" + methodPath + "#" + parameter.getSimpleName().toString() + ")");
                        }
        ...
        if (isReturnObservable) {
            if (routerRxTypeElement == null) {
                throw new com.cambodia.zhanbang.component.ProcessException("you must use router-rx lib,such as \n 'com.github.xiaojinzi123.Component:component-impl-rx:<version>' \n " +
            ...
            if (biCallBackParameter != null) {
                throw new com.cambodia.zhanbang.component.ProcessException("the parameter " + biCallBackParameter.getSimpleName() +
            ...
            if (callBackParameter != null) {
                throw new com.cambodia.zhanbang.component.ProcessException("the parameter " + callBackParameter.getSimpleName() +
                        " of method " + methodPath + " is not allow when then returnType is " + ComponentConstants.RXJAVA_COMPLETABLE + " or " + ComponentConstants.RXJAVA_SINGLE);
            }
            if (navigateAnnotation == null) {
                if (!isReturnCompletable) {
                    throw new com.cambodia.zhanbang.component.ProcessException("the returnType of method (" + methodPath + ") must be " + ComponentConstants.RXJAVA_COMPLETABLE);
                }
            } else {
                if (navigateAnnotation.forResult()) {
                    if (!isReturnSingle) {
                        throw new com.cambodia.zhanbang.component.ProcessException("the returnType of method (" + methodPath + ") must be " + ComponentConstants.RXJAVA_SINGLE + "<ActivityResult>");
                    }
                } else if (navigateAnnotation.forIntent()) {
                    if (!isReturnSingle) {
                        throw new com.cambodia.zhanbang.component.ProcessException("the returnType of method (" + methodPath + ") must be " + ComponentConstants.RXJAVA_SINGLE + "<Intent>");
                    }
                } else if (navigateAnnotation.forResultCode()) {
                    if (!isReturnSingle) {
                        throw new com.cambodia.zhanbang.component.ProcessException("the returnType of method (" + methodPath + ") must be " + ComponentConstants.RXJAVA_SINGLE + "<Integer>");
                    }
                } else {
                    if (!isReturnCompletable) {
                        throw new com.cambodia.zhanbang.component.ProcessException("the returnType of method (" + methodPath + ") must be " + ComponentConstants.RXJAVA_COMPLETABLE);
            ...
            if (navigateAnnotation == null) {
                ...
                if (navigateAnnotation.forResult()) {
                    if (biCallBackParameter == null) {
                        throw new com.cambodia.zhanbang.component.ProcessException("do you forget to add parameter(" + ComponentConstants.BICALLBACK_CLASS_NAME + "<ActivityResult>) to you method(" + methodPath + ")?");
                    }
                } else if (navigateAnnotation.forIntent()) {
                    if (biCallBackParameter == null) {
                        throw new com.cambodia.zhanbang.component.ProcessException("do you forget to add parameter(" + ComponentConstants.BICALLBACK_CLASS_NAME + "<Intent>) to you method(" + methodPath + ")?");
                    }
                } else if (navigateAnnotation.forResultCode()) {
                    if (biCallBackParameter == null) {
                        throw new com.cambodia.zhanbang.component.ProcessException("do you forget to add parameter(" + ComponentConstants.BICALLBACK_CLASS_NAME + "<Integer>) to you method(" + methodPath + ")?");
                    }
                } else {
                    // 说明是想匹配 resultCode
                    if (navigateAnnotation.resultCodeMatch() != Integer.MIN_VALUE) {
                        throw new com.cambodia.zhanbang.component.ProcessException("do you forget to add parameter(" + ComponentConstants.CALLBACK_CLASS_NAME + ") to you method(" + methodPath + ")?");
                    }
                }
            }
        }
